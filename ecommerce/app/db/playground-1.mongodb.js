...
db.getCollection('carts').insertMany([
  { userId : 1 , cartIds : ['123', '234']}, // cartIds care basically the list of productsIds that have been added to the user's cart 
  { userId : 2 , cartIds : ['345', '456']}, // cartIds care basically the list of productsIds that have been added to the user's cart 
])
